...
paper's attribution to AI rests on the horse race of manuscript Table 5 panel B — where the
...
| (i) | Value appears as input saving, conditional on complements | HA2 | **Supported** — +0.0496 on NUE (p = 0.014); zero at low complements, −0.2293 on N at high | manuscript Table 5 |
| (j) | Complement dependence is AI-specific, not generic | HA3 | **Supported** — opposite sign and margin vs the embodied waves and the placebo | manuscript Table 6 |
...
The full annual series behind Figure 11 and behind every growth figure quoted in Section
...
controls, standard errors clustered by country. This is the numerical content of Figure 15
...
| 6 | **Univariate R² for `year`** | −0.0079 | Table 2 omits the row | **Omission, not conflict.** Restored in [S1](#table-s1). |
